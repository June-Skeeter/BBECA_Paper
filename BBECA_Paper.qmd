...
## Results & Discussion (keep merged or split sections?)
...
[Projections of the mean-annual course of late 21st century (2080-2100?) daily TS compared to current observed and current modelled values](/figures/TS_est.png){#fig-TS}

[Projections of the mean-annual course of late 21st century (2080-2100?) daily WTD compared to current observed and current modelled values](/figures/WTD_est.png){#fig-WTD}
...
[Projections of the mean-annual course of late 21st century (2080-2100?) daily $F_CO2$ compared to current observed and current modelled values](/figures/FCO2_est.png){#fig-FCO2}

[Projections of the mean-annual course of late 21st century (2080-2100?) daily $F_CH4$ compared to current observed and current modelled values](/figures/FCH4_est.png){#fig-FCH4}

[Projections of the mean yearly $F_CO2$ for late 21st century (2080-2100?) compared to current observed and current modelled values](/figures/FCO2_est.png){#fig-FCO2}

[Projections of the mean yearly $F_CH4$ for late 21st century (2080-2100?) compared to current observed and current modelled values](/figures/FCH4_est.png){#fig-FCH4}
